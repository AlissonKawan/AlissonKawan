...
Estudante de **ADS na FIAP**, em transição de Suporte TI para **desenvolvimento back-end**.
Foco em **Java, Spring Boot, APIs REST e Banco de Dados**.

```
💼 Suporte TI → 🎯 Back-end Dev
📍 Brasil  |  ☕ Java  |  📚 FIAP
```
...
<div align="center">
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=00F7FF&height=100&section=footer"/>
</div>
